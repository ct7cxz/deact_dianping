...
<head>
    ...
    <script type="text/javascript" src="${basePath}/js/content/addAd.js"></script>

</head>
<%--新增广告界面--%>
<body style="background: #e1e9eb;">
<form id="mainForm" method="post" enctype="multipart/form-data" action="${basePath}/ad/saveAd">
        ...
        <div class="rightCont">
            ...
            <table class="tab1" width="100%">
                ...
                <tr>
                    ...
                    <td width="30%">
                        <input id="title" placeholder="请输入广告标题" name="title" class="allInput" style="width:100%;" type="text"/>
                    </td>
                ...
                <tr>
                    ...
                    <td width="30%">
                        <input id="weight" placeholder="请输入图片权重（数字）" name="weight" class="allInput" style="width:100%;" type="text"/>
                    </td>
                </tr>
                </tbody>
            </table>
