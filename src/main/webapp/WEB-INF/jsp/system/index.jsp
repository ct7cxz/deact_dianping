        ...
        <div class="iheader">
            ...
            <div style="height: 44px;">
                ...
                <div class="h_info">
                    ...
                    欢迎您！姓名[${user.name}]&nbsp; 当前时间：2017年03月20日&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <td class="leftTd" style="vertical-align:top" width="150">
                    <div class="left">
                        <div class="ileft" id="menuDiv">
                            <%--<h3 onclick="$('#mainPage').attr('src','${basePath}/index/list');"><a>列表页面</a></h3>--%>
                            <%--<h3 onclick="$('#mainPage').attr('src','${basePath}/index/addAd');"><a>新增广告</a></h3>--%>
                            <h3 onclick="$('#mainPage').attr('src','${basePath}/index/listAd');"><a>广告管理</a></h3>
                            <h3 onclick="$('#mainPage').attr('src','${basePath}/index/listBusiness');"><a>商户管理</a></h3>
                        </div>
                    </div>
                </td>
                <td width="7">
