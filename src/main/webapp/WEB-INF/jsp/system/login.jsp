...
<head>
    ...
    <script src="${basePath}/js/common/jquery.validate.min.js" type="text/javascript"></script>
    <script src="${basePath}/js/common/messages_zh.js" type="text/javascript"></script>
...
<div class="main">
    ...
    <div class="content">
        ...
        <form id="mainForm" method="post" action="${basePath}/admin/login">
            <fieldset>
                <div class="input">
                ...
                <div class="enter">
                    <input class="button hide" type="button" id="submit_login" value="登录" onclick="sub()" />
                </div>
            </fieldset>
        </form>
    </div>
